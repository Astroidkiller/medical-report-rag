...
*   **Multi-Tier Geolocation System:** Implements browser HTML5 Geolocation API, IP lookup API (`ipapi.co`) for city-level precision when GPS is blocked, and OpenStreetMap Nominatim Search geocoding to let the user type any address, postal code, or area and dynamically re-center coordinates.
