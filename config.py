...
LLM_MODELS = {
    "gemini": os.getenv("LLM_MODEL", "gemini-2.5-flash"),
    "vertex_ai": os.getenv("LLM_MODEL", "gemini-2.5-flash"),
...
EMBEDDING_MODEL = EMBEDDING_MODELS.get(EMBEDDING_BACKEND, "gemini-embedding-001")
